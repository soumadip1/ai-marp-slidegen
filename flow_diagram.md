...
flowchart TB
 subgraph ThreadPool[" "]
    direction TB
        T1["⚡ <b>Parallel Asset Factory</b><br>(Multi-threaded)"]
        ...
        M1["📊 Diagram Engine<br>mmdc (Mermaid CLI)"]
        M2["🖼️ PNG Converter<br>Saves to <i>assets/diagrams/</i>"]
        Fallback["📝 Text Fallback<br>Convert code to bullets"]
  end
    Start(["👤 User Topic"]) --> API["⚙️ <b>Initialization</b><br>Check API Keys (Unsplash/Pexels)<br>Load <i>md/prompt.md</i>"]
