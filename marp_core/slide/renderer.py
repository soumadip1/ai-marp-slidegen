...
def _build_closing_slide():
    ...
    return "\n".join([
        "# THANK YOU",
        "",
        '<div style="width: 100%; margin-top: 3em; text-align: right; color: #555555; font-size: 0.8em;">- Richa K &amp; Soumadip B</div>',
    ])
            ...
            if diagram and is_valid_mermaid(diagram) and not should_skip_diagram:
                ...
                if diagram_image_path:
                    ...
                    try:
                        ...
                        # Use explicit sizing with height constraint to prevent overflow.
                        # Height of 420px fits comfortably in remaining slide space.
                        # Centering is achieved via CSS rule for img[alt*="Diagram"]
                        slide_lines.append(f'![Diagram]({data_uri})')
                        ...
                        slide_lines.append(f"![Diagram]({relative_path})")
